...
// Package notepads is a generated GoMock package.
package notepads
...
func (m *MockRepo) Get(arg0 filter) ([]Notepad, error) {
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].([]Notepad)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepo) Create(arg0 Notepad) (Notepad, error) {
...
func (m *MockRepo) Update(arg0 Notepad) (Notepad, error) {
...
func (m *MockRepo) Delete(arg0 Notepad) error {
